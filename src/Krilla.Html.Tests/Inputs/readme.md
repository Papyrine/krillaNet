...
Boxes sit at zero across the whole corpus: all 94 scenarios match Chrome's geometry exactly. Pixels
are close behind — 64 read SSIM 1.0000 and 44 are identical outright.
...
The thirty below 1.0000 come down to named causes: `ua/hr` (0.9911) is Chrome's `inset` rule
