...
Boxes sit at zero across the whole corpus: all 69 scenarios match Chrome's geometry exactly, with
nothing unmatched. Pixels are close behind — 51 read SSIM 1.0000 and 37 are identical outright.
