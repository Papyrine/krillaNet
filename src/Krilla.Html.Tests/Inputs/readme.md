...
Boxes sit at zero across the whole corpus: all 80 scenarios match Chrome's geometry exactly. Pixels
are close behind — 58 read SSIM 1.0000 and 41 are identical outright.
...
The twenty-two below 1.0000 come down to named causes: `ua/hr` (0.9911) is Chrome's `inset` rule
